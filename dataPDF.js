...
function fetchData(data) {
  ...
  var doc = new jsPDF();
  doc.text(k + ' ' +  dataMoist + ' ' + dataWt + ' '+dataStat1), 20, 20);
  doc.save('Test.pdf');

}
    //var stringObj={k,dataMoist,dataStat,dataWt};
    //strArr.push(stringObj);
    /*jsonObj.push({
      "Id":k,
      "Moisture":dataMoist,
      "Weight":dataWt,
  ...
  for(var i = 0; i<strArr.length; i++) {
      doc.text(20, 10 + (i * 10),
          "Id: " + strArr[i];
          /*"Moisture: " + strArr[i].dataMoist +
          "Weight:" + strArr[i].dataStat +
          "Status:" + strArr[i].dataWt);*/
...
/*
    ...
    wb.Props = {
            ...
            Subject: "Test",
            Author: "NerdSphere",
            CreatedDate: new Date(2019,05,14)
    };
